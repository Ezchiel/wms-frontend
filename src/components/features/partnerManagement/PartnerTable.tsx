          ...
          <tr key={partner.id} className="hover:bg-gray-50 transition-colors">
            ...
            <td className="py-4.5 px-3.75 border-b border-b-wms-border-color text-wms-text-main">
              <button
                ...
                className="px-5 py-1 border border-wms-primary rounded-[7px] text-wms-primary cursor-pointer"
              >
                Edit
              </button>
              <button
                onClick={() => onDelete(partner.id)}
                className="mt-2 px-5 py-1 border border-wms-primary rounded-[7px] text-wms-primary cursor-pointer"
              >
                Delete
              </button>
            </td>
