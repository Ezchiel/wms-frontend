    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="flex items-start gap-3 p-3.5 bg-amber-50 border border-amber-200 rounded-xl">
        ...
        <p className="text-[12px] text-amber-800 leading-relaxed">
          Hệ thống đã chọn vị trí tối ưu dựa trên cùng loại sản phẩm đã có sẵn tại kệ và trình tự
          đường đi ngắn nhất.
        </p>
      </div>
      ...
      <button
        onClick={onProceed}
        className="w-full h-14 bg-wms-primary text-white font-bold rounded-xl flex items-center justify-center gap-2 hover:bg-wms-primary-hover active:scale-[0.98] transition-all shadow-lg"
      >
