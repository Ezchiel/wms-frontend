...
const FilterInventoryReceipt: React.FC<Props> = ({ onSearch, onActionClick }) => {
    ...
    <div className="flex justify-between items-center mb-6.25">
      <div className="flex items-center gap-3.75">
        <div className="flex items-center gap-2.5 text-[13px] font-medium">
          <label className="text-wms-text-main">Search Receipt</label>
          <input
...
export default FilterInventoryReceipt;
